...
goog.DEPENDENCIES_ENABLED &&
    ...
    (goog.writeScriptTag_ = function (a, b) {
        if (goog.inHtmlDocument_()) {
            ...
            void 0 === b
                ? d
                    ? ((d = " onreadystatechange='goog.onScriptLoad_(this, " + ++goog.lastNonModuleScriptIndex_ + ")' "), c.write('<script type="text/javascript" src="' + a + '"' + d + ">\x3c/script>"))
...
box2d.b2Assert = function (a, b, c) {
   // if (box2d.DEBUG && !a) throw Error();/ Fuck This Feature!!!!!!!!!! (>_<)
};
...
box2d.b2_maxPolygonVertices = 64;
...
box2d.b2DrawFlags = { e_none: 0, e_shapeBit: 1, e_jointBit: 2, e_aabbBit: 4, e_pairBit: 8, e_centerOfMassBit: 16, e_controllerBit: 32, e_particleBit: 64, e_all: 65535 };
...
box2d.b2Rot.prototype.Set = function (a) {
    Math.abs(this.angle - a) >= box2d.b2_epsilon && ((this.angle = a), (this.s = Math.sin(a)), (this.c = Math.cos(a)));
    return this;
};
...
box2d.b2Dot = function (a, b) {
    if (a instanceof box2d.b2Vec2 && b instanceof box2d.b2Vec2) return box2d.b2Dot_V2_V2(a, b);
    if (a instanceof box2d.b2Vec3 && b instanceof box2d.b2Vec3) return box2d.b2Dot_V3_V3(a, b);
    throw Error();
};
goog.exportSymbol("box2d.b2Dot", box2d.b2Dot);
box2d.b2Cross = function (a, b, c) {
    if (a instanceof box2d.b2Vec2 && b instanceof box2d.b2Vec2) return box2d.b2Cross_V2_V2(a, b);
    if (a instanceof box2d.b2Vec2 && "number" === typeof b && c instanceof box2d.b2Vec2) return box2d.b2Cross_V2_S(a, b, c);
    if ("number" === typeof a && b instanceof box2d.b2Vec2 && c instanceof box2d.b2Vec2) return box2d.b2Cross_S_V2(a, b, c);
    if (a instanceof box2d.b2Vec3 && b instanceof box2d.b2Vec3 && c instanceof box2d.b2Vec3) return box2d.b2Cross_V3_V3(a, b, c);
    throw Error();
};
goog.exportSymbol("box2d.b2Cross", box2d.b2Cross);
box2d.b2Add = function (a, b, c) {
    if (a instanceof box2d.b2Vec2 && b instanceof box2d.b2Vec2 && c instanceof box2d.b2Vec2) return box2d.b2Add_V2_V2(a, b, c);
    if (a instanceof box2d.b2Vec3 && b instanceof box2d.b2Vec3 && c instanceof box2d.b2Vec3) return box2d.b2Add_V3_V3(a, b, c);
    throw Error();
};
goog.exportSymbol("box2d.b2Add", box2d.b2Add);
box2d.b2Sub = function (a, b, c) {
    if (a instanceof box2d.b2Vec2 && b instanceof box2d.b2Vec2 && c instanceof box2d.b2Vec2) return box2d.b2Sub_V2_V2(a, b, c);
    if (a instanceof box2d.b2Vec3 && b instanceof box2d.b2Vec3 && c instanceof box2d.b2Vec3) return box2d.b2Sub_V3_V3(a, b, c);
    throw Error();
};
goog.exportSymbol("box2d.b2Sub", box2d.b2Sub);
box2d.b2Mul = function (a, b, c) {
    if (a instanceof box2d.b2Mat22 && b instanceof box2d.b2Vec2 && c instanceof box2d.b2Vec2) return box2d.b2Mul_M22_V2(a, b, c);
    if (a instanceof box2d.b2Mat22 && b instanceof box2d.b2Mat22 && c instanceof box2d.b2Mat22) return box2d.b2Mul_M22_M22(a, b, c);
    if (a instanceof box2d.b2Mat33 && b instanceof box2d.b2Vec3 && c instanceof box2d.b2Vec3) return box2d.b2Mul_M33_V3(a, b, c);
    if (a instanceof box2d.b2Rot && b instanceof box2d.b2Rot && c instanceof box2d.b2Rot) return box2d.b2Mul_R_R(a, b, c);
    if (a instanceof box2d.b2Rot && b instanceof box2d.b2Vec2 && c instanceof box2d.b2Vec2) return box2d.b2Mul_R_V2(a, b, c);
    if (a instanceof box2d.b2Transform && b instanceof box2d.b2Vec2 && c instanceof box2d.b2Vec2) return box2d.b2Mul_X_V2(a, b, c);
    if (a instanceof box2d.b2Transform && b instanceof box2d.b2Transform && c instanceof box2d.b2Transform) return box2d.b2Mul_X_X(a, b, c);
    throw Error();
};
goog.exportSymbol("box2d.b2Mul", box2d.b2Mul);
box2d.b2Mul22 = function (a, b, c) {
    if (a instanceof box2d.b2Mat33 && b instanceof box2d.b2Vec2) return box2d.b2Mul22_M33_V2(a, b, c);
    throw Error();
};
goog.exportSymbol("box2d.b2Mul22", box2d.b2Mul22);
box2d.b2MulT = function (a, b, c) {
    if (a instanceof box2d.b2Mat22 && b instanceof box2d.b2Vec2 && c instanceof box2d.b2Vec2) return box2d.b2MulT_M22_V2(a, b, c);
    if (a instanceof box2d.b2Mat22 && b instanceof box2d.b2Mat22 && c instanceof box2d.b2Mat22) return box2d.b2MulT_M22_M22(a, b, c);
    if (a instanceof box2d.b2Rot && b instanceof box2d.b2Rot && c instanceof box2d.b2Rot) return box2d.b2MulT_R_R(a, b, c);
    if (a instanceof box2d.b2Rot && b instanceof box2d.b2Vec2 && c instanceof box2d.b2Vec2) return box2d.b2MulT_R_V2(a, b, c);
    if (a instanceof box2d.b2Transform && b instanceof box2d.b2Vec2 && c instanceof box2d.b2Vec2) return box2d.b2MulT_X_V2(a, b, c);
    if (a instanceof box2d.b2Transform && b instanceof box2d.b2Transform && c instanceof box2d.b2Transform) return box2d.b2MulT_X_X(a, b, c);
    throw Error();
};
...
box2d.b2Simplex.prototype.ReadCache = function (a, b, c, d, e) {
    ...
    0 === this.m_count && ((h = f[0]), (h.indexA = 0), (h.indexB = 0), (k = b.GetVertex(0)), (l = d.GetVertex(0)), box2d.b2Mul_X_V2(c, k, h.wA), box2d.b2Mul_X_V2(e, l, h.wB), box2d.b2Sub_V2_V2(h.wB, h.wA, h.w), (this.m_count = h.a = 1));
};
...
box2d.b2Simplex.prototype.Solve2 = function () {
    ...
    0 >= a ? (this.m_count = this.m_v1.a = 1) : ((b = box2d.b2Dot_V2_V2(b, c)), 0 >= b ? ((this.m_count = this.m_v2.a = 1), this.m_v1.Copy(this.m_v2)) : ((c = 1 / (b + a)), (this.m_v1.a = b * c), (this.m_v2.a = a * c), (this.m_count = 2)));
};
...
box2d.b2Simplex.prototype.Solve3 = function () {
    ...
    0 >= e && 0 >= h
        ...
        : 0 < f && 0 < e && 0 >= a
        ? ((k = 1 / (f + e)), (this.m_v1.a = f * k), (this.m_v2.a = e * k), (this.m_count = 2))
        : 0 < k && 0 < h && 0 >= c
        ? ((f = 1 / (k + h)), (this.m_v1.a = k * f), (this.m_v3.a = h * f), (this.m_count = 2), this.m_v2.Copy(this.m_v3))
        : 0 >= f && 0 >= m
        ? ((this.m_count = this.m_v2.a = 1), this.m_v1.Copy(this.m_v2))
        : 0 >= k && 0 >= l
        ? ((this.m_count = this.m_v3.a = 1), this.m_v1.Copy(this.m_v3))
        : 0 < l && 0 < m && 0 >= d
        ? ((f = 1 / (l + m)), (this.m_v2.a = l * f), (this.m_v3.a = m * f), (this.m_count = 2), this.m_v1.Copy(this.m_v3))
        : ((f = 1 / (d + c + a)), (this.m_v1.a = d * f), (this.m_v2.a = c * f), (this.m_v3.a = a * f), (this.m_count = 3));
};
...
box2d.b2ShapeDistance = function (a, b, c) {
    ...
    for (var k = h.m_vertices, l = box2d.b2Distance.s_saveA, m = box2d.b2Distance.s_saveB, n = 0, p = 0; 20 > p; ) {
        for (var n = h.m_count, q = 0; q < n; ++q) (l[q] = k[q].indexA), (m[q] = k[q].indexB);
        switch (h.m_count) {
            case 1:
                break;
            case 2:
    ...
    c.useRadii &&
        ...
        a.distance > b + e && a.distance > box2d.b2_epsilon
            ? ((a.distance -= b + e), (c = box2d.b2Sub_V2_V2(a.pointB, a.pointA, box2d.b2Distance.s_normal)), c.Normalize(), a.pointA.SelfMulAdd(b, c), a.pointB.SelfMulSub(e, c))
            : ((r = box2d.b2Mid_V2_V2(a.pointA, a.pointB, box2d.b2Distance.s_p)), a.pointA.Copy(r), a.pointB.Copy(r), (a.distance = 0)));
};
...
box2d.b2GetPointStates = function (a, b, c, d) {
    ...
    for (f = d.pointCount; e < f; ++e)
        for (g = d.points[e].id, g = g.key, b[e] = box2d.b2PointState.b2_addState, h = 0, k = c.pointCount; h < k; ++h)
...
box2d.b2AABB.prototype.RayCast = function (a, b) {
    ...
    } else if (((k = 1 / g), (g = (this.lowerBound.x - e) * k), (e = (this.upperBound.x - e) * k), (k = -1), g > e && ((k = g), (g = e), (e = k), (k = 1)), g > c && ((m.x = k), (m.y = 0), (c = g)), (d = box2d.b2Min(d, e)), c > d))
        return !1;
    if (l < box2d.b2_epsilon) {
        if (f < this.lowerBound.y || this.upperBound.y < f) return !1;
    } else if (((k = 1 / h), (g = (this.lowerBound.y - f) * k), (e = (this.upperBound.y - f) * k), (k = -1), g > e && ((k = g), (g = e), (e = k), (k = 1)), g > c && ((m.x = 0), (m.y = k), (c = g)), (d = box2d.b2Min(d, e)), c > d))
        return !1;
...
box2d.b2TestOverlap = function (a, b, c, d, e, f) {
    if (a instanceof box2d.b2AABB && b instanceof box2d.b2AABB) return box2d.b2TestOverlap_AABB(a, b);
    if (a instanceof box2d.b2Shape && "number" === typeof b && c instanceof box2d.b2Shape && "number" === typeof d && e instanceof box2d.b2Transform && f instanceof box2d.b2Transform) return box2d.b2TestOverlap_Shape(a, b, c, d, e, f);
    throw Error();
};
...
box2d.b2CollideCircles = function (a, b, c, d, e) {
    ...
    e > c * c || ((a.type = box2d.b2ManifoldType.e_circles), a.localPoint.Copy(b.m_p), a.localNormal.SetZero(), (a.pointCount = 1), a.points[0].localPoint.Copy(d.m_p), (a.points[0].id.key = 0));
};
...
box2d.b2CollidePolygonAndCircle = function (a, b, c, d, e) {
    ...
    h = k[(l + 1) % h];
    g < box2d.b2_epsilon
        ? ((a.pointCount = 1), (a.type = box2d.b2ManifoldType.e_faceA), a.localNormal.Copy(b[f]), box2d.b2Mid_V2_V2(m, h, a.localPoint), a.points[0].localPoint.Copy(d.m_p), (a.points[0].id.key = 0))
        : ((g = box2d.b2Dot_V2_V2(box2d.b2Sub_V2_V2(c, m, box2d.b2Vec2.s_t0), box2d.b2Sub_V2_V2(h, m, box2d.b2Vec2.s_t1))),
          ...
          0 >= g
              ? box2d.b2DistanceSquared(c, m) > e * e ||
                ((a.pointCount = 1), (a.type = box2d.b2ManifoldType.e_faceA), box2d.b2Sub_V2_V2(c, m, a.localNormal).SelfNormalize(), a.localPoint.Copy(m), a.points[0].localPoint.Copy(d.m_p), (a.points[0].id.key = 0))
              : 0 >= f
              ? box2d.b2DistanceSquared(c, h) > e * e ||
                ((a.pointCount = 1), (a.type = box2d.b2ManifoldType.e_faceA), box2d.b2Sub_V2_V2(c, h, a.localNormal).SelfNormalize(), a.localPoint.Copy(h), a.points[0].localPoint.Copy(d.m_p), (a.points[0].id.key = 0))
              : ((f = box2d.b2Mid_V2_V2(m, h, box2d.b2CollidePolygonAndCircle.s_faceCenter)),
                (g = box2d.b2Dot_V2_V2(box2d.b2Sub_V2_V2(c, f, box2d.b2Vec2.s_t1), b[l])),
                g > e || ((a.pointCount = 1), (a.type = box2d.b2ManifoldType.e_faceA), a.localNormal.Copy(b[l]).SelfNormalize(), a.localPoint.Copy(f), a.points[0].localPoint.Copy(d.m_p), (a.points[0].id.key = 0))));
};
...
box2d.b2CollideEdgeAndCircle = function (a, b, c, d, e) {
    ...
    if (0 >= l) {
        ...
        if (!(k > m * m)) {
            if (b.m_hasVertex0 && ((b = box2d.b2Sub_V2_V2(f, b.m_vertex0, box2d.b2CollideEdgeAndCircle.s_e1)), 0 < box2d.b2Dot_V2_V2(b, box2d.b2Sub_V2_V2(f, c, box2d.b2Vec2.s_t0)))) return;
            e.cf.indexA = 0;
        ...
        if (((n = g), (k = box2d.b2Sub_V2_V2(c, n, box2d.b2CollideEdgeAndCircle.s_d)), (k = box2d.b2Dot_V2_V2(k, k)), !(k > m * m))) {
            if (b.m_hasVertex3 && ((f = box2d.b2Sub_V2_V2(b.m_vertex3, g, box2d.b2CollideEdgeAndCircle.s_e2)), 0 < box2d.b2Dot_V2_V2(f, box2d.b2Sub_V2_V2(c, g, box2d.b2Vec2.s_t0)))) return;
            e.cf.indexA = 1;
            e.cf.typeA = box2d.b2ContactFeatureType.e_vertex;
            a.pointCount = 1;
            a.type = box2d.b2ManifoldType.e_circles;
...
box2d.b2EPCollider.prototype.Collide = function (a, b, c, d, e) {
    ...
    c && b
        ...
        : c
        ? k
            ? ((this.m_front = 0 <= g || 0 <= f) ? (this.m_normal.Copy(this.m_normal1), this.m_lowerLimit.Copy(this.m_normal0)) : (this.m_normal.Copy(this.m_normal1).SelfNeg(), this.m_lowerLimit.Copy(this.m_normal1)),
        ...
        ? l
            ...
            : ((this.m_front = 0 <= f && 0 <= h) ? (this.m_normal.Copy(this.m_normal1), this.m_lowerLimit.Copy(this.m_normal1).SelfNeg()) : (this.m_normal.Copy(this.m_normal1).SelfNeg(), this.m_lowerLimit.Copy(this.m_normal2).SelfNeg()),
    ...
    f = 0;
    for (g = d.m_count; f < g; ++f) box2d.b2Mul_X_V2(this.m_xf, d.m_vertices[f], this.m_polygonB.vertices[f]), box2d.b2Mul_R_V2(this.m_xf.q, d.m_normals[f], this.m_polygonB.normals[f]);
    ...
    if (!(c.type === box2d.b2EPAxisType.e_unknown || c.separation > this.m_radius || ((b = this.ComputePolygonSeparation(box2d.b2EPCollider.s_polygonAxis)), b.type !== box2d.b2EPAxisType.e_unknown && b.separation > this.m_radius))) {
        ...
        if (c.type === box2d.b2EPAxisType.e_edgeA) {
            ...
            f = 1;
            for (g = this.m_polygonB.count; f < g; ++f) (l = box2d.b2Dot_V2_V2(this.m_normal, this.m_polygonB.normals[f])), l < k && ((k = l), (h = f));
            g = h;
        ...
        if (!(g < box2d.b2_maxManifoldPoints || ((g = box2d.b2ClipSegmentToLine(h, f, b.sideNormal2, b.sideOffset2, b.i2)), g < box2d.b2_maxManifoldPoints))) {
            c.type === box2d.b2EPAxisType.e_edgeA ? (a.localNormal.Copy(b.normal), a.localPoint.Copy(b.v1)) : (a.localNormal.Copy(d.m_normals[b.i1]), a.localPoint.Copy(d.m_vertices[b.i1]));
            f = d = 0;
            for (g = box2d.b2_maxManifoldPoints; f < g; ++f)
                box2d.b2Dot_V2_V2(b.normal, box2d.b2Sub_V2_V2(h[f].v, b.v1, box2d.b2Vec2.s_t0)) <= this.m_radius &&
                    ((e = a.points[d]),
                    c.type === box2d.b2EPAxisType.e_edgeA
                        ? (box2d.b2MulT_X_V2(this.m_xf, h[f].v, e.localPoint), (e.id = h[f].id))
                        : (e.localPoint.Copy(h[f].v), (e.id.cf.typeA = h[f].id.cf.typeB), (e.id.cf.typeB = h[f].id.cf.typeA), (e.id.cf.indexA = h[f].id.cf.indexB), (e.id.cf.indexB = h[f].id.cf.indexA)),
                    ++d);
            a.pointCount = d;
        }
    }
...
box2d.b2EPCollider.prototype.ComputePolygonSeparation = function (a) {
    ...
    for (var b = box2d.b2EPCollider.s_perp.Set(-this.m_normal.y, this.m_normal.x), c = 0, d = this.m_polygonB.count; c < d; ++c) {
        ...
        if (0 <= box2d.b2Dot_V2_V2(e, b)) {
            if (box2d.b2Dot_V2_V2(box2d.b2Sub_V2_V2(e, this.m_upperLimit, box2d.b2Vec2.s_t0), this.m_normal) < -box2d.b2_angularSlop) continue;
        } else if (box2d.b2Dot_V2_V2(box2d.b2Sub_V2_V2(e, this.m_lowerLimit, box2d.b2Vec2.s_t0), this.m_normal) < -box2d.b2_angularSlop) continue;
...
box2d.b2CollidePolygons = function (a, b, c, d, e) {
    ...
    if (!(h > f)) {
        ...
        if (!(l > f)) {
            var m = 0,
                n = 0;
            l > 0.98 * h + 0.001 ? ((h = d), (d = b), (b = e), (m = k[0]), (a.type = box2d.b2ManifoldType.e_faceB), (n = 1)) : ((h = b), (b = c), (c = e), (m = g[0]), (a.type = box2d.b2ManifoldType.e_faceA), (n = 0));
                ...
                for (k = g = 0; k < box2d.b2_maxManifoldPoints; ++k)
                    (e = p[k]),
                        box2d.b2Dot_V2_V2(m, e.v) - b <= f &&
                            ...
                            h.id.Copy(e.id),
                            n && ((e = h.id.cf), (h.id.cf.indexA = e.indexB), (h.id.cf.indexB = e.indexA), (h.id.cf.typeA = e.typeB), (h.id.cf.typeB = e.typeA)),
                            ++g);
                a.pointCount = g;
            }
        }
    ...
    if (null === this.m_root) (this.m_root = a), (this.m_root.parent = null);
        ...
        for (var c = this.m_root, d, e; !c.IsLeaf(); ) {
            ...
            var h = g.GetPerimeter(),
                ...
                l,
                m;
            d.IsLeaf() ? (k.Combine2(b, d.aabb), (f = k.GetPerimeter() + h)) : (k.Combine2(b, d.aabb), (l = d.aabb.GetPerimeter()), (m = k.GetPerimeter()), (f = m - l + h));
            e.IsLeaf() ? (k.Combine2(b, e.aabb), (h = k.GetPerimeter() + h)) : (k.Combine2(b, e.aabb), (l = e.aabb.GetPerimeter()), (m = k.GetPerimeter()), (h = m - l + h));
            if (g < f && g < h) break;
            c = f < h ? d : e;
        }
        d = c.parent;
        ...
        e.height = c.height + 1;
        d ? (d.child1 === c ? (d.child1 = e) : (d.child2 = e), (e.child1 = c), (e.child2 = a), (c.parent = e), (a.parent = e)) : ((e.child1 = c), (e.child2 = a), (c.parent = e), (this.m_root = a.parent = e));
...
box2d.b2DynamicTree.prototype.Balance = function (a) {
    ...
    if (1 < d) {
        ...
        d.height > e.height
            ? ((c.child2 = d), (a.child2 = e), (e.parent = a), a.aabb.Combine2(b.aabb, e.aabb), c.aabb.Combine2(a.aabb, d.aabb), (a.height = 1 + box2d.b2Max(b.height, e.height)), (c.height = 1 + box2d.b2Max(a.height, d.height)))
            : ((c.child2 = e), (a.child2 = d), (d.parent = a), a.aabb.Combine2(b.aabb, d.aabb), c.aabb.Combine2(a.aabb, e.aabb), (a.height = 1 + box2d.b2Max(b.height, d.height)), (c.height = 1 + box2d.b2Max(a.height, e.height)));
        return c;
    }
    return -1 > d
        ? ((d = b.child1),
          ...
          (b.parent = a.parent),
          (a.parent = b),
          null !== b.parent ? (b.parent.child1 === a ? (b.parent.child1 = b) : (box2d.ENABLE_ASSERTS && box2d.b2Assert(b.parent.child2 === a), (b.parent.child2 = b))) : (this.m_root = b),
          d.height > e.height
              ? ((b.child2 = d), (a.child1 = e), (e.parent = a), a.aabb.Combine2(c.aabb, e.aabb), b.aabb.Combine2(a.aabb, d.aabb), (a.height = 1 + box2d.b2Max(c.height, e.height)), (b.height = 1 + box2d.b2Max(a.height, d.height)))
              : ((b.child2 = e), (a.child1 = d), (d.parent = a), a.aabb.Combine2(c.aabb, d.aabb), b.aabb.Combine2(a.aabb, e.aabb), (a.height = 1 + box2d.b2Max(c.height, d.height)), (b.height = 1 + box2d.b2Max(a.height, e.height))),
          b)
        : a;
};
...
box2d.b2DynamicTree.prototype.ValidateStructure = function (a) {
    if (null !== a) {
        ...
        a.IsLeaf()
            ...
            : (box2d.ENABLE_ASSERTS && box2d.b2Assert(b.parent === a), box2d.ENABLE_ASSERTS && box2d.b2Assert(c.parent === a), this.ValidateStructure(b), this.ValidateStructure(c));
    }
};
...
box2d.b2DynamicTree.prototype.GetMaxBalance = function () {
    var a;
    a = this.m_root;
    null === a ? (a = 0) : 1 >= a.height ? (a = 0) : (box2d.ENABLE_ASSERTS && box2d.b2Assert(!a.IsLeaf()), (a = box2d.b2Abs(a.child2.height - a.child1.height)), (a = box2d.b2Max(0, a)));
    return a;
};
...
box2d.b2CircleShape.prototype.RayCast = function (a, b, c, d) {
    ...
    f = -(f + box2d.b2Sqrt(e));
    return 0 <= f && f <= b.maxFraction * g ? ((f /= g), (a.fraction = f), box2d.b2AddMul_V2_S_V2(c, f, d, a.normal).SelfNormalize(), !0) : !1;
};
...
box2d.b2CircleShape.prototype.ComputeSubmergedArea = function (a, b, c, d) {
    ...
    if (e > this.m_radius) return d.Copy(c), box2d.b2_pi * this.m_radius * this.m_radius;
...
box2d.b2ChainShape.prototype.CreateLoop = function (a, b) {
    ...
    if (box2d.ENABLE_ASSERTS) for (var c = 1; c < b; ++c) box2d.b2Assert(box2d.b2DistanceSquared(a[c - 1], a[c]) > box2d.b2_linearSlop * box2d.b2_linearSlop);
    this.m_count = b + 1;
...
box2d.b2ChainShape.prototype.Dump = function () {
    ...
    for (var a = 0; a < this.m_count; ++a) box2d.b2Log("    vs[%d].Set(%.15f, %.15f);\n", a, this.m_vertices[a].x, this.m_vertices[a].y);
...
box2d.b2PolygonShape.prototype.SetAsBox = function (a, b, c, d) {
    ...
    if (c instanceof box2d.b2Vec2)
        for (d = "number" === typeof d ? d : 0, this.m_centroid.Copy(c), a = new box2d.b2Transform(), a.SetPosition(c), a.SetRotationAngle(d), c = 0, d = this.m_count; c < d; ++c)
            box2d.b2Mul_X_V2(a, this.m_vertices[c], this.m_vertices[c]), box2d.b2Mul_R_V2(a.q, this.m_normals[c], this.m_normals[c]);
    return this;
};
   ...
   // box2d.ENABLE_ASSERTS && box2d.b2Assert(3 <= b && b <= box2d.b2_maxPolygonVertices);
    ...
    for (var d = box2d.b2PolygonShape.prototype.Set.s_ps, e = 0, f = 0; f < b; ++f) {
        for (var g = a[c + f], h = !0, k = 0; k < e; ++k)
            if (box2d.b2DistanceSquared(g, d[k]) < 0.25 * box2d.b2_linearSlop * box2d.b2_linearSlop) {
                h = !1;
                break;
            }
        h && d[e++].Copy(g);
    ...
    b = e;
    if (3 > b) return box2d.ENABLE_ASSERTS && box2d.b2Assert(!1), this.SetAsBox(1, 1);
    a = 0;
    g = d[0].x;
    for (f = 1; f < b; ++f) if (((k = d[f].x), k > g || (k === g && d[f].y < d[a].y))) (a = f), (g = k);
...
box2d.b2PolygonShape.prototype.TestPoint = function (a, b) {
    for (var c = box2d.b2MulT_X_V2(a, b, box2d.b2PolygonShape.prototype.TestPoint.s_pLocal), d = 0, e = this.m_count; d < e; ++d)
        if (0 < box2d.b2Dot_V2_V2(this.m_normals[d], box2d.b2Sub_V2_V2(c, this.m_vertices[d], box2d.b2Vec2.s_t0))) return !1;
    return !0;
};
...
box2d.b2PolygonShape.prototype.RayCast = function (a, b, c, d) {
    ...
    for (var e = box2d.b2MulT_X_V2(c, b.p2, box2d.b2PolygonShape.prototype.RayCast.s_p2), e = box2d.b2Sub_V2_V2(e, d, box2d.b2PolygonShape.prototype.RayCast.s_d), f = 0, g = b.maxFraction, h = -1, k = 0, l = this.m_count; k < l; ++k) {
        ...
        if (0 === n) {
            if (0 > m) return !1;
        } else 0 > n && m < f * n ? ((f = m / n), (h = k)) : 0 < n && m < g * n && (g = m / n);
        if (g < f) return !1;
    }
    box2d.ENABLE_ASSERTS && box2d.b2Assert(0 <= f && f <= b.maxFraction);
    return 0 <= h ? ((a.fraction = f), box2d.b2Mul_R_V2(c.q, this.m_normals[h], a.normal), !0) : !1;
};
...
box2d.b2PolygonShape.prototype.ComputeSubmergedArea = function (a, b, c, d) {
    ...
    switch (h) {
        case 0:
            return l ? ((a = box2d.b2PolygonShape.prototype.ComputeSubmergedArea.s_md), this.ComputeMass(a, 1), box2d.b2Mul_X_V2(c, a.center, d), a.mass) : 0;
        case 1:
    ...
    1 === b
        ...
        : (a.indexA[0] === a.indexA[1]
              ? ((this.m_type = box2d.b2SeparationFunctionType.e_faceB),
                ...
                (b = this.m_proxyA.GetVertex(a.indexA[0])),
                (c = box2d.b2Mul_X_V2(c, b, box2d.b2TimeOfImpact.s_pointA)),
                (a = box2d.b2Dot_V2_V2(box2d.b2Sub_V2_V2(c, e, box2d.b2Vec2.s_t0), f)))
...
box2d.b2Fixture.prototype.Refilter = function () {
    if (null !== this.m_body) {
        ...
        if (null !== a) for (a = a.m_contactManager.m_broadPhase, b = 0; b < this.m_proxyCount; ++b) a.TouchProxy(this.m_proxies[b].proxy);
    }
};
...
box2d.b2Body.prototype.CreateFixture = function (a, b) {
    ...
    if (a instanceof box2d.b2Shape && "number" === typeof b) return this.CreateFixture_Shape_Density(a, b);
    throw Error();
};
...
box2d.b2Body.prototype.SetTransform = function (a, b, c) {
    if (a instanceof box2d.b2Vec2 && "number" === typeof b) this.SetTransform_X_Y_A(a.x, a.y, b);
    else if (a instanceof box2d.b2Transform) this.SetTransform_X_Y_A(a.p.x, a.p.y, a.GetAngle());
    else if ("number" === typeof a && "number" === typeof b && "number" === typeof c) this.SetTransform_X_Y_A(a, b, c);
    else throw Error();
};
...
box2d.b2Body.prototype.SetLinearVelocity = function (a) {
    this.m_type !== box2d.b2BodyType.b2_staticBody && (0 < box2d.b2Dot_V2_V2(a, a) && this.SetAwake(!0), this.m_linearVelocity.Copy(a));
};
...
box2d.b2Body.prototype.ApplyForce = function (a, b, c) {
    this.m_type === box2d.b2BodyType.b2_dynamicBody &&
        (!this.m_flag_awakeFlag && this.SetAwake(!0), this.m_flag_awakeFlag && ((this.m_force.x += a.x), (this.m_force.y += a.y), (this.m_torque += (b.x - this.m_sweep.c.x) * a.y - (b.y - this.m_sweep.c.y) * a.x)));
};
...
box2d.b2Body.prototype.ApplyForceToCenter = function (a, b) {
    this.m_type === box2d.b2BodyType.b2_dynamicBody && (("boolean" === typeof b ? b : 1) && !this.m_flag_awakeFlag && this.SetAwake(!0), this.m_flag_awakeFlag && ((this.m_force.x += a.x), (this.m_force.y += a.y)));
};
...
box2d.b2Body.prototype.ApplyTorque = function (a, b) {
    this.m_type === box2d.b2BodyType.b2_dynamicBody && (("boolean" === typeof b ? b : 1) && !this.m_flag_awakeFlag && this.SetAwake(!0), this.m_flag_awakeFlag && (this.m_torque += a));
};
...
box2d.b2Body.prototype.ApplyLinearImpulse = function (a, b, c) {
    this.m_type === box2d.b2BodyType.b2_dynamicBody &&
        (("boolean" === typeof c ? c : 1) && !this.m_flag_awakeFlag && this.SetAwake(!0),
...
box2d.b2Body.prototype.ApplyLinearImpulseToCenter = function (a, b) {
    this.m_type === box2d.b2BodyType.b2_dynamicBody &&
        (("boolean" === typeof b ? b : 1) && !this.m_flag_awakeFlag && this.SetAwake(!0), this.m_flag_awakeFlag && ((this.m_linearVelocity.x += this.m_invMass * a.x), (this.m_linearVelocity.y += this.m_invMass * a.y)));
};
...
box2d.b2Body.prototype.ApplyAngularImpulse = function (a, b) {
    this.m_type === box2d.b2BodyType.b2_dynamicBody && (("boolean" === typeof b ? b : 1) && !this.m_flag_awakeFlag && this.SetAwake(!0), this.m_flag_awakeFlag && (this.m_angularVelocity += this.m_invI * a));
};
...
box2d.b2Body.prototype.SetMassData = function (a) {
    ...
    if (!this.m_world.IsLocked() && this.m_type === box2d.b2BodyType.b2_dynamicBody) {
        ...
        0 < a.I && !this.m_flag_fixedRotationFlag && ((this.m_I = a.I - this.m_mass * box2d.b2Dot_V2_V2(a.center, a.center)), box2d.ENABLE_ASSERTS && box2d.b2Assert(0 < this.m_I), (this.m_invI = 1 / this.m_I));
...
box2d.b2Body.prototype.ResetMassData = function () {
    ...
    if (this.m_type === box2d.b2BodyType.b2_staticBody || this.m_type === box2d.b2BodyType.b2_kinematicBody) this.m_sweep.c0.Copy(this.m_xf.p), this.m_sweep.c.Copy(this.m_xf.p), (this.m_sweep.a0 = this.m_sweep.a);
        ...
        0 < this.m_I && !this.m_flag_fixedRotationFlag ? ((this.m_I -= this.m_mass * box2d.b2Dot_V2_V2(a, a)), box2d.ENABLE_ASSERTS && box2d.b2Assert(0 < this.m_I), (this.m_invI = 1 / this.m_I)) : (this.m_invI = this.m_I = 0);
...
box2d.b2Body.prototype.SetType = function (a) {
    ...
    if (!this.m_world.IsLocked() && this.m_type !== a) {
        ...
        a = this.m_world.m_contactManager.m_broadPhase;
        for (b = this.m_fixtureList; b; b = b.m_next) for (var c = b.m_proxyCount, d = 0; d < c; ++d) a.TouchProxy(b.m_proxies[d].proxy);
    }
};
...
box2d.b2Body.prototype.SetSleepingAllowed = function (a) {
    a ? (this.m_flag_autoSleepFlag = !0) : ((this.m_flag_autoSleepFlag = !1), this.SetAwake(!0));
};
...
box2d.b2Body.prototype.SetAwake = function (a) {
    a
        ? this.m_flag_awakeFlag || ((this.m_flag_awakeFlag = !0), (this.m_sleepTime = 0))
        : ((this.m_flag_awakeFlag = !1), (this.m_sleepTime = 0), this.m_linearVelocity.SetZero(), (this.m_angularVelocity = 0), this.m_force.SetZero(), (this.m_torque = 0));
};
...
box2d.b2Body.prototype.SetFixedRotation = function (a) {
    this.m_flag_fixedRotationFlag !== a && ((this.m_flag_fixedRotationFlag = a), (this.m_angularVelocity = 0), this.ResetMassData());
};
...
box2d.b2Body.prototype.ShouldCollideConnected = function (a) {
    for (var b = this.m_jointList; b; b = b.next) if (b.other === a && !b.joint.m_collideConnected) return !1;
    return !0;
};
...
box2d.b2ContactFilter.prototype.ShouldCollide = function (a, b) {
    var c = a.GetBody(),
        d = b.GetBody();
    if ((d.GetType() === box2d.b2BodyType.b2_staticBody && c.GetType() === box2d.b2BodyType.b2_staticBody) || !1 === d.ShouldCollideConnected(c)) return !1;
    c = a.GetFilterData();
    d = b.GetFilterData();
...
box2d.b2Contact.prototype.Update = function (a) {
    ...
    var c = !1,
        ...
        c = e.GetTransform(),
        g = f.GetTransform();
    if (d) (e = this.m_fixtureA.GetShape()), (f = this.m_fixtureB.GetShape()), (c = box2d.b2TestOverlap_Shape(e, this.m_indexA, f, this.m_indexB, c, g)), (this.m_manifold.pointCount = 0);
    else {
...
box2d.b2ContactFactory.prototype.AddType = function (a, b, c, d) {
    ...
    c !== d && ((this.m_registers[d][c].pool = e), (this.m_registers[d][c].createFcn = b), (this.m_registers[d][c].destroyFcn = f), (this.m_registers[d][c].primary = !1));
};
...
box2d.b2ContactFactory.prototype.Create = function (a, b, c, d) {
    ...
    f = e.createFcn;
    return null !== f ? (e.primary ? ((e = f(this.m_allocator)), e.Reset(a, b, c, d)) : ((e = f(this.m_allocator)), e.Reset(c, d, a, b)), e) : null;
};
...
box2d.b2ContactManager.prototype.Collide = function () {
    for (var a = this.m_contactList; a; ) {
        ...
        f || g ? (this.m_broadPhase.TestOverlap(b.m_proxies[d].proxy, c.m_proxies[e].proxy) ? (a.Update(this.m_contactListener), (a = a.m_next)) : ((b = a), (a = b.m_next), this.Destroy(b))) : (a = a.m_next);
    }
};
    ...
    if (g !== h) {
        for (var k = h.GetContactList(); k; ) {
            if (k.other === g) {
                ...
                if ((l === c && m === d && n === e && p === f) || (l === d && m === c && n === f && p === e)) return;
            }
            k = k.next;
        }
        !h.ShouldCollide(g) ||
...
box2d.b2ContactSolver.prototype.Initialize = function (a) {
    ...
    for (b = this.m_count; a < b; ++a)
        for (
            ...
            (h = g.points[c]),
                (l = f.points[c]),
                this.m_step.warmStarting ? ((l.normalImpulse = this.m_step.dtRatio * h.normalImpulse), (l.tangentImpulse = this.m_step.dtRatio * h.tangentImpulse)) : ((l.normalImpulse = 0), (l.tangentImpulse = 0)),
                l.rA.SetZero(),
                l.rB.SetZero(),
                (l.normalMass = 0),
                (l.tangentMass = 0),
...
box2d.b2ContactSolver.prototype.InitializeVelocityConstraints = function () {
    var a,
        ...
        B = box2d.b2ContactSolver.prototype.InitializeVelocityConstraints.s_worldManifold;
    a = 0;
    for (b = this.m_count; a < b; ++a) {
        ...
        2 === e.pointCount &&
            ...
            (v = l + m + n * h * h + p * k * k),
            (l = l + m + n * f * h + p * t * k),
            w * w < 1e3 * (w * v - l * l) ? (e.K.ex.Set(w, l), e.K.ey.Set(l, v), e.K.GetInverse(e.normalMass)) : (e.pointCount = 1));
    }
};
...
box2d.b2Island.prototype.Initialize = function (a, b, c, d, e) {
    ...
    this.m_allocator = d;
    for (this.m_listener = e; this.m_bodies.length < a; ) this.m_bodies[this.m_bodies.length] = null;
    ...
    if (this.m_positions.length < a)
        for (b = box2d.b2Max(2 * this.m_positions.length, a), box2d.DEBUG && window.console.log("box2d.b2Island.m_positions: " + b); this.m_positions.length < b; ) this.m_positions[this.m_positions.length] = new box2d.b2Position();
...
box2d.b2Island.prototype.Solve = function (a, b, c, d) {
    ...
    for (g = 0; g < b.velocityIterations; ++g) {
        for (l = 0; l < this.m_jointCount; ++l) this.m_joints[l].SolveVelocityConstraints(h);
    ...
    for (g = 0; g < this.m_bodyCount; ++g) {
        ...
        box2d.b2Dot_V2_V2(p, p) > box2d.b2_maxTranslationSquared && ((p = box2d.b2_maxTranslation / p.Length()), m.SelfMul(p));
        p = f * n;
    ...
    for (g = 0; g < b.positionIterations; ++g) {
        ...
        n = !0;
        for (l = 0; l < this.m_jointCount; ++l) (p = this.m_joints[l].SolvePositionConstraints(h)), (n = n && p);
        if (m && n) {
            k = !0;
            break;
        }
        ...
        for (g = 0; g < this.m_bodyCount; ++g)
            (h = this.m_bodies[g]),
                h.GetType() !== box2d.b2BodyType.b2_staticBody &&
                    (!h.m_flag_autoSleepFlag || h.m_angularVelocity * h.m_angularVelocity > e || box2d.b2Dot_V2_V2(h.m_linearVelocity, h.m_linearVelocity) > d
                        ? (a = h.m_sleepTime = 0)
                        : ((h.m_sleepTime += f), (a = box2d.b2Min(a, h.m_sleepTime))));
        if (a >= box2d.b2_timeToSleep && k) for (g = 0; g < this.m_bodyCount; ++g) (h = this.m_bodies[g]), h.SetAwake(!1);
    }
};
...
box2d.b2Island.prototype.SolveTOI = function (a, b, c) {
    ...
    for (d = 0; d < this.m_bodyCount; ++d) {
        ...
        box2d.b2Dot_V2_V2(h, h) > box2d.b2_maxTranslationSquared && ((h = box2d.b2_maxTranslation / h.Length()), f.SelfMul(h));
        h = a * g;
...
box2d.b2AreaJoint.prototype.SolveVelocityConstraints = function (a) {
    for (var b = 0, c = 0, d = 0, e = this.m_bodies.length; d < e; ++d) var f = this.m_bodies[d], g = a.velocities[f.m_islandIndex].v, h = this.m_deltas[d], b = b + h.LengthSquared() / f.GetMass(), c = c + box2d.b2Cross_V2_V2(g, h);
    b = (-2 * c) / b;
    this.m_impulse += b;
    d = 0;
    for (e = this.m_bodies.length; d < e; ++d) (f = this.m_bodies[d]), (g = a.velocities[f.m_islandIndex].v), (h = this.m_deltas[d]), (g.x += f.m_invMass * h.y * 0.5 * b), (g.y += f.m_invMass * -h.x * 0.5 * b);
};
...
box2d.b2FrictionJoint.prototype.SolveVelocityConstraints = function (a) {
    ...
    m = l * this.m_maxForce;
    this.m_linearImpulse.LengthSquared() > m * m && (this.m_linearImpulse.Normalize(), this.m_linearImpulse.SelfMul(m));
...
box2d.b2World.prototype.SetAllowSleeping = function (a) {
    if (a !== this.m_allowSleep && ((this.m_allowSleep = a), !this.m_allowSleep)) for (a = this.m_bodyList; a; a = a.m_next) a.SetAwake(!0);
};
...
box2d.b2World.prototype.SetGravity = function (a, b) {
    b = b || !0;
    if (this.m_gravity.x !== a.x || this.m_gravity.y !== a.y) if ((this.m_gravity.Copy(a), b)) for (var c = this.m_bodyList; c; c = c.m_next) c.SetAwake(!0);
};
...
box2d.b2World.prototype.DestroyBody = function (a) {
    ...
    if (!this.IsLocked()) {
        ...
        for (b = a.m_fixtureList; b; )
            (c = b), (b = b.m_next), this.m_destructionListener && this.m_destructionListener.SayGoodbyeFixture(c), c.DestroyProxies(this.m_contactManager.m_broadPhase), c.Destroy(), (a.m_fixtureList = b), --a.m_fixtureCount;
...
box2d.b2World.prototype.CreateJoint = function (a) {
    ...
    var c = a.bodyA,
        d = a.bodyB;
    if (!a.collideConnected) for (a = d.GetContactList(); a; ) a.other === c && a.contact.FlagForFiltering(), (a = a.next);
    return b;
};
...
box2d.b2World.prototype.DestroyJoint = function (a) {
    ...
    if (!this.IsLocked()) {
        ...
        --this.m_jointCount;
        if (!b) for (a = d.GetContactList(); a; ) a.other === c && a.contact.FlagForFiltering(), (a = a.next);
    }
};
...
box2d.b2World.prototype.CreateParticleSystem = function (a) {
    ...
    a.m_prev = null;
    if ((a.m_next = this.m_particleSystemList)) this.m_particleSystemList.m_prev = a;
...
box2d.b2World.prototype.DestroyParticleSystem = function (a) {
    box2d.ENABLE_ASSERTS && box2d.b2Assert(!this.IsLocked());
    this.IsLocked() || (a.m_prev && (a.m_prev.m_next = a.m_next), a.m_next && (a.m_next.m_prev = a.m_prev), a === this.m_particleSystemList && (this.m_particleSystemList = a.m_next));
};
...
box2d.b2World.prototype.Solve = function (a) {
    ...
    for (var d = this.m_contactManager.m_contactList; d; d = d.m_next) d.m_flag_islandFlag = !1;
    ...
    for (var d = this.m_bodyCount, e = this.s_stack, f = this.m_bodyList; f; f = f.m_next)
        if (!f.m_flag_islandFlag && f.IsAwake() && f.IsActive() && f.GetType() !== box2d.b2BodyType.b2_staticBody) {
            ...
            for (f.m_flag_islandFlag = !0; 0 < g; )
                if (((b = e[--g]), box2d.ENABLE_ASSERTS && box2d.b2Assert(b.IsActive()), c.AddBody(b), b.SetAwake(!0), b.GetType() !== box2d.b2BodyType.b2_staticBody)) {
                    for (var h = b.m_contactList; h; h = h.next) {
                        var k = h.contact;
                        if (!k.m_flag_islandFlag && k.IsEnabled() && k.IsTouching()) {
                            var l = k.m_fixtureB.m_isSensor;
                            k.m_fixtureA.m_isSensor || l || (c.AddContact(k), (k.m_flag_islandFlag = !0), (k = h.other), k.m_flag_islandFlag || (box2d.ENABLE_ASSERTS && box2d.b2Assert(g < d), (e[g++] = k), (k.m_flag_islandFlag = !0)));
                        }
                    }
                    for (b = b.m_jointList; b; b = b.next)
                        b.joint.m_islandFlag ||
                            ((k = b.other), k.IsActive() && (c.AddJoint(b.joint), (b.joint.m_islandFlag = !0), k.m_flag_islandFlag || (box2d.ENABLE_ASSERTS && box2d.b2Assert(g < d), (e[g++] = k), (k.m_flag_islandFlag = !0))));
                }
            ...
            for (g = 0; g < c.m_bodyCount; ++g) (b = c.m_bodies[g]), b.GetType() === box2d.b2BodyType.b2_staticBody && (b.m_flag_islandFlag = !1);
        }
    for (g = 0; g < e.length && e[g]; ++g) e[g] = null;
    a = new box2d.b2Timer();
    for (b = this.m_bodyList; b; b = b.m_next) b.m_flag_islandFlag && b.GetType() !== box2d.b2BodyType.b2_staticBody && b.SynchronizeFixtures();
...
box2d.b2World.prototype.SolveTOI = function (a) {
    ...
    if (this.m_stepComplete) {
        for (var c = this.m_bodyList; c; c = c.m_next) (c.m_flag_islandFlag = !1), (c.m_sweep.alpha0 = 0);
        for (var d = this.m_contactManager.m_contactList; d; d = d.m_next) (d.m_flag_toiFlag = d.m_flag_islandFlag = !1), (d.m_toiCount = 0), (d.m_toi = 1);
    }
    for (;;) {
        for (var e = null, c = 1, d = this.m_contactManager.m_contactList; d; d = d.m_next)
            if (d.IsEnabled() && !(d.m_toiCount > box2d.b2_maxSubSteps)) {
                ...
                if (d.m_flag_toiFlag) f = d.m_toi;
                    ...
                    if (!l && !m) continue;
                    m = f.m_sweep.alpha0;
                    f.m_sweep.alpha0 < k.m_sweep.alpha0 ? ((m = k.m_sweep.alpha0), f.m_sweep.Advance(m)) : k.m_sweep.alpha0 < f.m_sweep.alpha0 && ((m = f.m_sweep.alpha0), k.m_sweep.Advance(m));
        ...
        if (e.IsEnabled() && e.IsTouching()) {
            ...
            for (e = 0; 2 > e; ++e)
                if (((d = 0 === e ? f : k), d.m_type === box2d.b2BodyType.b2_dynamicBody))
                    for (g = d.m_contactList; g && b.m_bodyCount !== b.m_bodyCapacity && b.m_contactCount !== b.m_contactCapacity; g = g.next)
                        (h = g.contact),
                            !h.m_flag_islandFlag &&
                                ((m = g.other), m.m_type !== box2d.b2BodyType.b2_dynamicBody || d.IsBullet() || m.IsBullet()) &&
                                ((l = h.m_fixtureB.m_isSensor),
                                h.m_fixtureA.m_isSensor ||
                                    l ||
                                    ((l = box2d.b2World.prototype.SolveTOI.s_backup.Copy(m.m_sweep)),
                                    m.m_flag_islandFlag || m.Advance(c),
                                    h.Update(this.m_contactManager.m_contactListener),
                                    h.IsEnabled()
                                        ? h.IsTouching()
                                            ? ((h.m_flag_islandFlag = !0), b.AddContact(h), m.m_flag_islandFlag || ((m.m_flag_islandFlag = !0), m.m_type !== box2d.b2BodyType.b2_staticBody && m.SetAwake(!0), b.AddBody(m)))
            ...
            for (e = 0; e < b.m_bodyCount; ++e)
                if (((d = b.m_bodies[e]), (d.m_flag_islandFlag = !1), d.m_type === box2d.b2BodyType.b2_dynamicBody))
                    for (d.SynchronizeFixtures(), g = d.m_contactList; g; g = g.next) g.contact.m_flag_toiFlag = g.contact.m_flag_islandFlag = !1;
            this.m_contactManager.FindNewContacts();
            if (this.m_subStepping) {
                this.m_stepComplete = !1;
                break;
            }
        } else e.SetEnabled(!1), f.m_sweep.Copy(d), k.m_sweep.Copy(g), f.SynchronizeTransform(), k.SynchronizeTransform();
    }
};
...
box2d.b2World.prototype.Step = function (a, b, c, d) {
    ...
    this.m_continuousPhysics && 0 < f.dt && ((a = new box2d.b2Timer()), this.SolveTOI(f), (this.m_profile.solveTOI = a.GetMilliseconds()));
...
box2d.b2World.prototype.QueryAABB = function (a, b) {
    ...
    if (a instanceof box2d.b2QueryCallback) for (var d = this.m_particleSystemList; d; d = d.m_next) a.ShouldQueryParticleSystem(d) && d.QueryAABB(a, b);
};
...
box2d.b2World.prototype.QueryShape = function (a, b, c, d) {
    ...
    if (a instanceof box2d.b2QueryCallback) for (d = this.m_particleSystemList; d; d = d.m_next) a.ShouldQueryParticleSystem(d) && d.QueryAABB(a, f);
};
...
box2d.b2World.prototype.QueryPoint = function (a, b, c) {
    ...
    if (a instanceof box2d.b2QueryCallback) for (c = this.m_particleSystemList; c; c = c.m_next) a.ShouldQueryParticleSystem(c) && c.QueryAABB(a, e);
};
...
box2d.b2World.prototype.RayCast = function (a, b, c) {
    ...
    if (a instanceof box2d.b2RayCastCallback) for (e = this.m_particleSystemList; e; e = e.m_next) a.ShouldQueryParticleSystem(e) && e.RayCast(a, b, c);
};
...
box2d.b2World.prototype.DrawShape = function (a, b) {
    ...
    switch (c.m_type) {
        ...
        case box2d.b2ShapeType.e_chainShape:
            ...
            for (var g = 1; g < d; ++g) (e = f[g]), this.m_debugDraw.DrawSegment(c, e, b), this.m_debugDraw.DrawCircle(e, 0.05, b), (c = e);
            break;
        case box2d.b2ShapeType.e_polygonShape:
            (d = c instanceof box2d.b2PolygonShape ? c : null), (c = d.m_count), (f = d.m_vertices), this.m_debugDraw.DrawSolidPolygon(f, c, b);
    }
};
...
box2d.b2World.prototype.DrawJoint = function (a) {
    ...
    switch (a.m_type) {
        ...
        case box2d.b2JointType.e_mouseJoint:
            ...
            break;
        default:
            this.m_debugDraw.DrawSegment(d, c, f), this.m_debugDraw.DrawSegment(c, b, f), this.m_debugDraw.DrawSegment(e, b, f);
    }
};
...
box2d.b2World.prototype.DrawDebugData = function () {
    if (null !== this.m_debugDraw) {
        ...
        if (a & box2d.b2DrawFlags.e_particleBit) for (c = this.m_particleSystemList; c; c = c.m_next) this.DrawParticleSystem(c);
        if (a & box2d.b2DrawFlags.e_jointBit) for (c = this.m_jointList; c; c = c.m_next) this.DrawJoint(c);
        ...
        if (a & box2d.b2DrawFlags.e_centerOfMassBit) for (c = this.m_bodyList; c; c = c.m_next) (d = box2d.b2World.prototype.DrawDebugData.s_xf), d.q.Copy(c.m_xf.q), d.p.Copy(c.GetWorldCenter()), this.m_debugDraw.DrawTransform(d);
        if (a & box2d.b2DrawFlags.e_controllerBit) for (a = this.m_controllerList; a; a = a.m_next) a.Draw(this.m_debugDraw);
    }
};
...
box2d.b2World.prototype.CalculateReasonableParticleIterations = function (a) {
    return null === this.m_particleSystemList
        ...
        : box2d.b2CalculateParticleIterations(
              ...
              (function (a) {
                  var c = box2d.b2_maxFloat;
                  for (a = a.GetParticleSystemList(); null !== a; a = a.m_next) c = box2d.b2Min(c, a.GetRadius());
                  return c;
              })(this),
              a
          );
...
box2d.b2MotorJoint.prototype.SetLinearOffset = function (a) {
    if (a.x != this.m_linearOffset.x || a.y != this.m_linearOffset.y) this.m_bodyA.SetAwake(!0), this.m_bodyB.SetAwake(!0), this.m_linearOffset.Copy(a);
};
...
box2d.b2MotorJoint.prototype.SolveVelocityConstraints = function (a) {
    ...
    var n = this.m_angularImpulse - p,
        ...
        u = this.m_rB,
        n = box2d.b2Add_V2_V2(
            box2d.b2Sub_V2_V2(box2d.b2Add_V2_V2(d, box2d.b2Cross_S_V2(e, u, box2d.b2Vec2.s_t0), box2d.b2Vec2.s_t0), box2d.b2Add_V2_V2(b, box2d.b2Cross_S_V2(c, r, box2d.b2Vec2.s_t1), box2d.b2Vec2.s_t1), box2d.b2Vec2.s_t2),
            box2d.b2Mul_S_V2(m * this.m_correctionFactor, this.m_linearError, box2d.b2Vec2.s_t3),
...
box2d.b2MouseJoint.prototype.InitVelocityConstraints = function (a) {
    ...
    d *= 0.98;
    a.step.warmStarting
        ? (this.m_impulse.SelfMul(a.step.dtRatio), (c.x += this.m_invMassB * this.m_impulse.x), (c.y += this.m_invMassB * this.m_impulse.y), (d += this.m_invIB * box2d.b2Cross_V2_V2(this.m_rB, this.m_impulse)))
        : this.m_impulse.SetZero();
...
box2d.b2MouseJoint.prototype.SolveVelocityConstraints = function (a) {
    var b = a.velocities[this.m_indexB].v,
        ...
        d = box2d.b2Mul_M22_V2(
            this.m_mass,
            box2d.b2Add_V2_V2(d, box2d.b2Add_V2_V2(this.m_C, box2d.b2Mul_S_V2(this.m_gamma, this.m_impulse, box2d.b2Vec2.s_t0), box2d.b2Vec2.s_t0), box2d.b2Vec2.s_t0).SelfNeg(),
...
box2d.b2PrismaticJoint.prototype.SolveVelocityConstraints = function (a) {
    ...
    this.m_enableLimit && this.m_limitState !== box2d.b2LimitState.e_inactiveLimit
        ? ((l = box2d.b2Dot_V2_V2(this.m_axis, box2d.b2Sub_V2_V2(d, b, box2d.b2Vec2.s_t0)) + this.m_a2 * e - this.m_a1 * c),
        ...
        : ((l = this.m_K.Solve22(-n, -p, box2d.b2PrismaticJoint.prototype.SolveVelocityConstraints.s_df2)),
...
box2d.b2PrismaticJoint.prototype.SolvePositionConstraints = function (a) {
    ...
    this.m_enableLimit &&
        ...
        box2d.b2Abs(this.m_upperTranslation - this.m_lowerTranslation) < 2 * box2d.b2_linearSlop
            ? ((B = box2d.b2Clamp(q, -box2d.b2_maxLinearCorrection, box2d.b2_maxLinearCorrection)), (n = box2d.b2Max(n, box2d.b2Abs(q))), (z = !0))
            : q <= this.m_lowerTranslation
            ? ((B = box2d.b2Clamp(q - this.m_lowerTranslation + box2d.b2_linearSlop, -box2d.b2_maxLinearCorrection, 0)), (n = box2d.b2Max(n, this.m_lowerTranslation - q)), (z = !0))
            : q >= this.m_upperTranslation && ((B = box2d.b2Clamp(q - this.m_upperTranslation - box2d.b2_linearSlop, 0, box2d.b2_maxLinearCorrection)), (n = box2d.b2Max(n, q - this.m_upperTranslation)), (z = !0)));
    if (z) {
        var q = l * t + m * w,
            E = l * t * u + m * w * g,
            z = l + m;
...
box2d.b2PrismaticJoint.prototype.GetJointSpeed = function () {
    ...
    return (
        ...
        box2d.b2Dot_V2_V2(f, box2d.b2Sub_V2_V2(box2d.b2AddCross_V2_S_V2(h, b, d, box2d.b2Vec2.s_t0), box2d.b2AddCross_V2_S_V2(g, a, c, box2d.b2Vec2.s_t1), box2d.b2Vec2.s_t0))
    );
};
...
box2d.b2RevoluteJoint.prototype.InitVelocityConstraints = function (a) {
    ...
    a.step.warmStarting
        ? (this.m_impulse.SelfMulScalar(a.step.dtRatio),
          ...
          f.SelfMulAdd(k, b),
          (g += m * (box2d.b2Cross_V2_V2(this.m_rB, b) + this.m_motorImpulse + this.m_impulse.z)))
        : (this.m_impulse.SetZero(), (this.m_motorImpulse = 0));
    a.velocities[this.m_indexA].w = d;
...
box2d.b2RevoluteJoint.prototype.SolveVelocityConstraints = function (a) {
    ...
    this.m_enableLimit && this.m_limitState !== box2d.b2LimitState.e_inactiveLimit && !l
        ? ((l = box2d.b2Sub_V2_V2(box2d.b2AddCross_V2_S_V2(d, e, this.m_rB, box2d.b2Vec2.s_t0), box2d.b2AddCross_V2_S_V2(b, c, this.m_rA, box2d.b2Vec2.s_t1), box2d.b2RevoluteJoint.prototype.SolveVelocityConstraints.s_Cdot1)),
        ...
        : ((m = box2d.b2Sub_V2_V2(box2d.b2AddCross_V2_S_V2(d, e, this.m_rB, box2d.b2Vec2.s_t0), box2d.b2AddCross_V2_S_V2(b, c, this.m_rA, box2d.b2Vec2.s_t1), box2d.b2RevoluteJoint.prototype.SolveVelocityConstraints.s_Cdot)),
...
box2d.b2RevoluteJoint.prototype.SolvePositionConstraints = function (a) {
    ...
    if (this.m_enableLimit && this.m_limitState !== box2d.b2LimitState.e_inactiveLimit && !k) {
        var l = e - c - this.m_referenceAngle,
            k = 0;
        this.m_limitState === box2d.b2LimitState.e_equalLimits
            ? ((l = box2d.b2Clamp(l - this.m_lowerAngle, -box2d.b2_maxAngularCorrection, box2d.b2_maxAngularCorrection)), (k = -this.m_motorMass * l), (h = box2d.b2Abs(l)))
            : this.m_limitState === box2d.b2LimitState.e_atLowerLimit
            ? ((l -= this.m_lowerAngle), (h = -l), (l = box2d.b2Clamp(l + box2d.b2_angularSlop, -box2d.b2_maxAngularCorrection, 0)), (k = -this.m_motorMass * l))
            : this.m_limitState === box2d.b2LimitState.e_atUpperLimit && ((h = l -= this.m_upperAngle), (l = box2d.b2Clamp(l - box2d.b2_angularSlop, 0, box2d.b2_maxAngularCorrection)), (k = -this.m_motorMass * l));
        c -= this.m_invIA * k;
        e += this.m_invIB * k;
    }
    f.SetAngle(c);
...
box2d.b2GearJoint = function (a) {
    ...
    this.m_typeA === box2d.b2JointType.e_revoluteJoint
        ? ((c = a.joint1), this.m_localAnchorC.Copy(c.m_localAnchorA), this.m_localAnchorA.Copy(c.m_localAnchorB), (this.m_referenceAngleA = c.m_referenceAngle), this.m_localAxisC.SetZero(), (b = d - e - this.m_referenceAngleA))
        : ((e = a.joint1),
    ...
    this.m_typeB === box2d.b2JointType.e_revoluteJoint
        ? ((c = a.joint2), this.m_localAnchorD.Copy(c.m_localAnchorA), this.m_localAnchorB.Copy(c.m_localAnchorB), (this.m_referenceAngleB = c.m_referenceAngle), this.m_localAxisD.SetZero(), (c = e - f - this.m_referenceAngleB))
        : ((e = a.joint2),
...
box2d.b2GearJoint.prototype.InitVelocityConstraints = function (a) {
    ...
    this.m_mass = 0;
    this.m_typeA === box2d.b2JointType.e_revoluteJoint
        ? (this.m_JvAC.SetZero(), (this.m_JwC = this.m_JwA = 1), (this.m_mass += this.m_iA + this.m_iC))
        : ((l = box2d.b2Mul_R_V2(q, this.m_localAxisC, box2d.b2GearJoint.prototype.InitVelocityConstraints.s_u)),
    ...
    this.m_typeB === box2d.b2JointType.e_revoluteJoint
        ? (this.m_JvBD.SetZero(), (this.m_JwD = this.m_JwB = this.m_ratio), (this.m_mass += this.m_ratio * this.m_ratio * (this.m_iB + this.m_iD)))
        : ((l = box2d.b2Mul_R_V2(g, this.m_localAxisD, box2d.b2GearJoint.prototype.InitVelocityConstraints.s_u)),
...
box2d.b2GearJoint.prototype.SolvePositionConstraints = function (a) {
    var b = a.positions[this.m_indexA].c,
        ...
        t,
        w = 0;
    if (this.m_typeA === box2d.b2JointType.e_revoluteJoint) q.SetZero(), (l = u = 1), (w += this.m_iA + this.m_iC), (n = c - g - this.m_referenceAngleA);
    else {
    ...
    if (this.m_typeB === box2d.b2JointType.e_revoluteJoint) r.SetZero(), (m = t = this.m_ratio), (w += this.m_ratio * this.m_ratio * (this.m_iB + this.m_iD)), (p = e - k - this.m_referenceAngleB);
    else {
...
box2d.b2WeldJoint.prototype.InitVelocityConstraints = function (a) {
    ...
    } else 0 === n.ez.z ? n.GetInverse22(this.m_mass) : n.GetSymInverse33(this.m_mass), (this.m_bias = this.m_gamma = 0);
    a.step.warmStarting
        ? (this.m_impulse.SelfMulScalar(a.step.dtRatio),
...
box2d.b2WeldJoint.prototype.SolvePositionConstraints = function (a) {
    ...
    if (0 < this.m_frequencyHz) {
        ...
        (r = box2d.b2Sub_V2_V2(box2d.b2Add_V2_V2(d, p, box2d.b2Vec2.s_t0), box2d.b2Add_V2_V2(b, n, box2d.b2Vec2.s_t1), box2d.b2WeldJoint.prototype.SolvePositionConstraints.s_C1)),
            ...
            0 < q.ez.z ? q.Solve33(r.x, r.y, p, n).SelfNeg() : ((q = q.Solve22(r.x, r.y, box2d.b2WeldJoint.prototype.SolvePositionConstraints.s_impulse2).SelfNeg()), (n.x = q.x), (n.y = q.y), (n.z = 0)),
...
box2d.b2WheelJoint.prototype.InitVelocityConstraints = function (a) {
    ...
    this.m_enableMotor ? ((this.m_motorMass = d + e), 0 < this.m_motorMass && (this.m_motorMass = 1 / this.m_motorMass)) : (this.m_motorImpulse = this.m_motorMass = 0);
    a.step.warmStarting
        ? ((this.m_impulse *= a.step.dtRatio),
...
box2d.b2ParticleColor = function (a, b, c, d) {
    if (0 !== arguments.length)
        if (a instanceof box2d.b2Color) (this.r = 0 | (255 * a.r)), (this.g = 0 | (255 * a.g)), (this.b = 0 | (255 * a.b)), (this.a = 0 | (255 * a.a));
        else if (3 <= arguments.length) (this.r = 0 | a || 0), (this.g = 0 | b || 0), (this.b = 0 | c || 0), (this.a = 0 | d || 0);
        else throw Error();
};
...
box2d.b2ParticleGroupFlag = { b2_solidParticleGroup: 1, b2_rigidParticleGroup: 2, b2_particleGroupCanBeEmpty: 4, b2_particleGroupWillBeDestroyed: 8, b2_particleGroupNeedsUpdateDepth: 16 };
...
box2d.b2ParticleGroup.prototype.DestroyParticles = function (a) {
    ...
    if (!this.m_system.m_world.IsLocked()) for (var b = this.m_firstIndex; b < this.m_lastIndex; b++) this.m_system.DestroyParticle(b, a);
};
...
box2d.b2ParticleGroup.prototype.UpdateStatistics = function () {
    ...
    if (this.m_timestamp != this.m_system.m_timestamp) {
        ...
        for (var d = this.m_firstIndex; d < this.m_lastIndex; d++) this.m_center.SelfMulAdd(c, this.m_system.m_positionBuffer.data[d]), this.m_linearVelocity.SelfMulAdd(c, this.m_system.m_velocityBuffer.data[d]);
...
box2d.std_remove_if = function (a, b, c) {
    ...
    for (var d = 0, e = 0; e < c; ++e) b(a[e]) || (e === d ? ++d : box2d.std_iter_swap(a, d++, e));
    return d;
};
...
box2d.std_rotate = function (a, b, c, d) {
    for (var e = c; b !== e; ) box2d.std_iter_swap(a, b++, e++), e === d ? (e = c) : b === c && (c = e);
};
...
box2d.b2FixtureParticleQueryCallback.prototype.ReportFixture = function (a) {
    ...
    for (var b = a.GetShape().GetChildCount(), c = 0; c < b; c++) for (var d = a.GetAABB(c), d = this.m_system.GetInsideBoundsEnumerator(d), e; 0 <= (e = d.GetNext()); ) this.ReportFixtureAndParticle(a, c, e);
    return !0;
};
...
box2d.b2ParticleContact.prototype.ApproximatelyEqual = function (a) {
    return this.indexA === a.indexA && this.indexB === a.indexB && this.flags === a.flags && 0.01 > box2d.b2Abs(this.weight - a.weight) && 1e-4 > box2d.b2DistanceSquared(this.normal, a.normal);
};
...
box2d.b2ParticleSystem.prototype.CreateParticle = function (a) {
    ...
    if (this.m_count >= this.m_internalAllocatedCapacity)
        if (this.m_def.destroyByAge) this.DestroyOldestParticle(0, !1), this.SolveZombie();
    ...
    if (this.m_colorBuffer.data || !a.color.IsZero()) (this.m_colorBuffer.data = this.RequestBuffer(this.m_colorBuffer.data)), (this.m_colorBuffer.data[b] = (this.m_colorBuffer.data[b] || new box2d.b2ParticleColor()).Copy(a.color));
    ...
    var c = this.m_proxyBuffer.data[this.m_proxyBuffer.Append()],
        d = 0 < a.lifetime;
    if (this.m_expirationTimeBuffer.data || d) this.SetParticleLifetime(b, d ? a.lifetime : this.ExpirationTimeToLifetime(-this.GetQuantizedTimeElapsed())), (this.m_indexByExpirationTimeBuffer.data[b] = b);
    c.index = b;
    c = a.group;
    if ((this.m_groupBuffer[b] = c)) c.m_firstIndex < c.m_lastIndex ? (this.RotateBuffer(c.m_firstIndex, c.m_lastIndex, b), box2d.b2Assert(c.m_lastIndex === b)) : (c.m_firstIndex = b), (c.m_lastIndex = b + 1);
...
box2d.b2ParticleSystem.prototype.CreateParticleGroup = function (a) {
    ...
    if (a.particleCount) {
        ...
        for (var d = 0; d < a.particleCount; d++) this.CreateParticleForGroup(a, b, a.positionData[d]);
    }
    var e = this.m_count,
...
box2d.b2ParticleSystem.prototype.SetParticleFlags = function (a, b) {
    ...
    ~this.m_allParticleFlags & b &&
        (b & box2d.b2ParticleFlag.b2_tensileParticle && (this.m_accumulation2Buffer = this.RequestBuffer(this.m_accumulation2Buffer)),
...
box2d.b2ParticleSystem.prototype.SetParticleLifetime = function (a, b) {
    ...
    if (c) for (var c = this.GetParticleCount(), d = 0; d < c; ++d) this.m_indexByExpirationTimeBuffer.data[d] = d;
    c = b / this.m_def.lifetimeGranularity;
    c = 0 < c ? this.GetQuantizedTimeElapsed() + c : c;
    c !== this.m_expirationTimeBuffer.data[a] && ((this.m_expirationTimeBuffer.data[a] = c), (this.m_expirationTimeBufferRequiresSorting = !0));
};
...
box2d.b2ParticleSystem.prototype.ParticleApplyForce = function (a, b) {
    box2d.b2ParticleSystem.IsSignificantForce(b) && this.ForceCanBeApplied(this.m_flagsBuffer.data[a]) && (this.PrepareForceBuffer(), this.m_forceBuffer[a].SelfAdd(b));
};
...
box2d.b2ParticleSystem.prototype.ApplyForce = function (a, b, c) {
    ...
    if (box2d.b2ParticleSystem.IsSignificantForce(c)) for (this.PrepareForceBuffer(), e = a; e < b; e++) this.m_forceBuffer[e].SelfAdd(c);
};
    ...
    if (0 !== this.m_proxyBuffer.count)
        for (
            var c = this.m_proxyBuffer.count,
                d = box2d.std_lower_bound(this.m_proxyBuffer.data, 0, c, box2d.b2ParticleSystem.computeTag(this.m_inverseDiameter * b.lowerBound.x, this.m_inverseDiameter * b.lowerBound.y), box2d.b2ParticleSystem.Proxy.CompareProxyTag),
                c = box2d.std_upper_bound(this.m_proxyBuffer.data, d, c, box2d.b2ParticleSystem.computeTag(this.m_inverseDiameter * b.upperBound.x, this.m_inverseDiameter * b.upperBound.y), box2d.b2ParticleSystem.Proxy.CompareTagProxy),
            ...
            var f = this.m_proxyBuffer.data[d].index,
                g = e[f];
            if (b.lowerBound.x < g.x && g.x < b.upperBound.x && b.lowerBound.y < g.y && g.y < b.upperBound.y && !a.ReportParticle(this, f)) break;
        }
};
...
box2d.b2ParticleSystem.InsideBoundsEnumerator.prototype.GetNext = function () {
    for (; this.m_first < this.m_last; ) {
        ...
        if (a >= this.m_xLower && a <= this.m_xUpper) return this.m_system.m_proxyBuffer.data[this.m_first++].index;
        this.m_first++;
    }
...
box2d.b2ParticleSystem.prototype.RequestBuffer = function (a) {
    a || (0 === this.m_internalAllocatedCapacity && this.ReallocateInternalAllocatedBuffers(box2d.b2_minParticleSystemBufferCapacity), (a = []), (a.length = this.m_internalAllocatedCapacity));
    return a;
};
...
box2d.b2ParticleSystem.prototype.CreateParticlesStrokeShapeForGroup = function (a, b, c) {
    ...
    for (var h = 0, k = a.GetChildCount(), l = 0; l < k; l++) {
        var m = null;
        a.GetType() === box2d.b2ShapeType.e_edgeShape ? (m = a) : (box2d.b2Assert(a.GetType() === box2d.b2ShapeType.e_chainShape), (m = d), a.GetChildEdge(m, l));
...
box2d.b2ParticleSystem.CompositeShape.prototype.TestPoint = function (a, b) {
    for (var c = 0; c < this.m_shapeCount; c++) if (this.m_shapes[c].TestPoint(a, b)) return !0;
    return !1;
};
...
box2d.b2ParticleSystem.prototype.DestroyParticleGroup = function (a) {
    ...
    for (var b = a.m_firstIndex; b < a.m_lastIndex; b++) this.m_groupBuffer[b] = null;
    a.m_prev && (a.m_prev.m_next = a.m_next);
    a.m_next && (a.m_next.m_prev = a.m_prev);
    ...
    if (h & box2d.b2ParticleSystem.k_triadFlags) {
        ...
        for (k = a; k < b; k++)
            (m = this.m_flagsBuffer.data[k]),
                ...
                m & box2d.b2ParticleFlag.b2_zombieParticle || !box2d.b2ParticleSystem.ParticleCanBeConnected(m, n) || (c.IsNecessary(k) && ++l, h.AddGenerator(g[k], k, c.IsNecessary(k)));
...
box2d.b2ParticleSystem.prototype.UpdatePairsAndTriadsWithReactiveParticles = function () {
    ...
    for (a = 0; a < this.m_count; a++) this.m_flagsBuffer.data[a] &= ~box2d.b2ParticleFlag.b2_reactiveParticle;
...
box2d.b2ParticleSystem.prototype.MergeParticleListsInContact = function (a, b) {
    for (var c = a.GetBufferIndex(), d = 0; d < this.m_contactBuffer.count; d++) {
        var e = this.m_contactBuffer.data[d],
            f = e.indexA,
            e = e.indexB;
        if (a.ContainsParticle(f) && a.ContainsParticle(e) && ((f = b[f - c].list), (e = b[e - c].list), f !== e)) {
            if (f.count < e.count)
                var g = f,
                    f = e,
                    e = g;
...
box2d.b2ParticleSystem.prototype.ComputeDepth = function () {
    ...
    for (c = this.m_groupList; c; c = c.GetNext())
        if (c.m_groupFlags & box2d.b2ParticleGroupFlag.b2_particleGroupNeedsUpdateDepth)
            for (g[h++] = c, this.SetGroupFlags(c, c.m_groupFlags & ~box2d.b2ParticleGroupFlag.b2_particleGroupNeedsUpdateDepth), f = c.m_firstIndex; f < c.m_lastIndex; f++) this.m_accumulationBuffer[f] = 0;
    for (c = 0; c < b; c++) {
        var d = a[c],
            e = d.indexA,
            f = d.indexB,
    ...
    for (f = 0; f < h; f++) for (c = g[f], f = c.m_firstIndex; f < c.m_lastIndex; f++) (k = this.m_accumulationBuffer[f]), (this.m_depthBuffer[f] = 0.8 > k ? 0 : box2d.b2_maxFloat);
    ...
    for (f = 0; f < h; f++) for (c = g[f], f = c.m_firstIndex; f < c.m_lastIndex; f++) this.m_depthBuffer[f] = this.m_depthBuffer[f] < box2d.b2_maxFloat ? this.m_depthBuffer[f] * this.m_particleDiameter : 0;
};
...
box2d.b2ParticleSystem.prototype.UpdateAllGroupFlags = function () {
    ...
    for (var a = this.m_groupList; a; a = a.GetNext()) this.m_allGroupFlags |= a.m_groupFlags;
...
box2d.b2ParticleSystem.prototype.FindContacts_Reference = function (a) {
    ...
    for (var b = (this.m_contactBuffer.count = 0), c = 0; b < a; b++) {
        ...
        for (e = c; e < a && !(d < this.m_proxyBuffer.data[e].tag); e++) this.AddContact(this.m_proxyBuffer.data[b].index, this.m_proxyBuffer.data[e].index, this.m_contactBuffer);
    }
};
...
box2d.b2ParticleSystem.prototype.NotifyBodyContactListenerPreContact = function (a) {
    if (null !== this.GetFixtureContactListener()) throw (a.Initialize(this.m_bodyContactBuffer, this.m_flagsBuffer), Error());
};
...
box2d.b2ParticleSystem.prototype.UpdateBodyContacts = function () {
    ...
    if (0 < this.m_stuckThreshold)
        for (var c = this.GetParticleCount(), d = 0; d < c; d++) (this.m_bodyContactCountBuffer.data[d] = 0), this.m_timestamp > this.m_lastBodyContactStepBuffer.data[d] + 1 && (this.m_consecutiveContactStepsBuffer.data[d] = 0);
...
box2d.b2ParticleSystem.prototype.Solve = function (a) {
    ...
    if (
        ...
        for (this.m_iterationIndex = 0; this.m_iterationIndex < a.particleIterations; this.m_iterationIndex++) {
            ...
            for (var d = 0; d < this.m_count; d++) this.m_positionBuffer.data[d].SelfMulAdd(c.dt, this.m_velocityBuffer.data[d]);
        }
};
...
box2d.b2ParticleSystem.SolveCollisionCallback.prototype.ReportFixtureAndParticle = function (a, b, c) {
    ...
    0 === this.m_system.m_iterationIndex
        ? ((d = box2d.b2MulT_X_V2(l.m_xf0, m, d)),
          a.GetShape().GetType() === box2d.b2ShapeType.e_circleShape && (d.SelfSub(l.GetLocalCenter()), box2d.b2Mul_R_V2(l.m_xf0.q, d, d), box2d.b2MulT_R_V2(l.m_xf.q, d, d), d.SelfAdd(l.GetLocalCenter())),
        ...
        if (x.flags & box2d.b2ParticleFlag.b2_barrierParticle) {
            ...
            for (
                ...
                if (E !== I && F !== I) {
                    ...
                    this.IsRigidGroup(I)
                        ? ((t = I.GetMass()), (A = I.GetInertia()), 0 < t && I.m_linearVelocity.SelfMulAdd(1 / t, C), 0 < A && (I.m_angularVelocity += box2d.b2Cross_V2_V2(box2d.b2Sub_V2_V2(H, I.GetCenter(), box2d.b2Vec2.s_t0), C) / A))
                        : r[G].SelfAdd(A);
...
box2d.b2ParticleSystem.prototype.SolvePressure = function (a) {
    ...
    if (this.m_allParticleFlags & box2d.b2ParticleSystem.k_noPressureFlags) for (h = 0; h < this.m_count; h++) this.m_flagsBuffer.data[h] & box2d.b2ParticleSystem.k_noPressureFlags && (this.m_accumulationBuffer[h] = 0);
    if (this.m_allParticleFlags & box2d.b2ParticleFlag.b2_staticPressureParticle)
        for (box2d.b2Assert(null !== this.m_staticPressureBuffer), h = 0; h < this.m_count; h++)
...
box2d.b2ParticleSystem.prototype.SolveDamping = function (a) {
    ...
    for (var g = this.GetParticleInvMass(), h = 0; h < this.m_bodyContactBuffer.count; h++) {
        ...
        0 > r && ((n = box2d.b2Max(f * n, box2d.b2Min(-a * r, 0.5))), (p = box2d.b2Mul_S_V2(n * p * r, q, c)), e[l].SelfMulAdd(g, p), m.ApplyLinearImpulse(p.SelfNeg(), k, !0));
    }
    for (h = 0; h < this.m_contactBuffer.count; h++)
        (k = this.m_contactBuffer.data[h]),
            (l = k.indexA),
            ...
            (r = box2d.b2Dot_V2_V2(r, q)),
            0 > r && ((n = box2d.b2Max(f * n, box2d.b2Min(-a * r, 0.5))), (p = box2d.b2Mul_S_V2(n * r, q, c)), e[l].SelfAdd(p), e[m].SelfSub(p));
};
...
box2d.b2ParticleSystem.prototype.SolveRigidDamping = function () {
    for (
        ...
        if (this.IsRigidGroup(u)) {
            ...
            0 > v &&
                (this.InitDampingParameterWithRigidGroupOrParticle(e, f, g, !0, u, r, q, w),
    ...
    for (p = 0; p < this.m_contactBuffer.count; p++) {
        ...
        u !== y &&
            ...
            (v = box2d.b2Dot_V2_V2(v, w)),
            0 > v &&
                (this.InitDampingParameterWithRigidGroupOrParticle(e, f, g, z, u, r, q, w),
...
box2d.b2ParticleSystem.prototype.SolveExtraDamping = function () {
    for (
        var a = box2d.b2ParticleSystem.prototype.SolveExtraDamping.s_v, b = box2d.b2ParticleSystem.prototype.SolveExtraDamping.s_f, c = this.m_velocityBuffer.data, d = this.m_positionBuffer.data, e = this.GetParticleInvMass(), f = 0;
        ...
        if (this.m_flagsBuffer.data[h] & box2d.b2ParticleSystem.k_extraDampingFlags) {
            ...
            0 > n && ((l = box2d.b2Mul_S_V2(0.5 * l * n, m, b)), c[h].SelfMulAdd(e, l), k.ApplyLinearImpulse(l.SelfNeg(), g, !0));
        }
    }
};
...
box2d.b2ParticleSystem.prototype.SolveWall = function () {
    for (var a = this.m_velocityBuffer.data, b = 0; b < this.m_count; b++) this.m_flagsBuffer.data[b] & box2d.b2ParticleFlag.b2_wallParticle && a[b].SetZero();
};
box2d.b2ParticleSystem.prototype.SolveRigid = function (a) {
    for (
        ...
        if (h.m_groupFlags & box2d.b2ParticleGroupFlag.b2_rigidParticleGroup) {
            ...
            for (m = h.m_firstIndex; m < h.m_lastIndex; m++) box2d.b2Mul_X_V2(k, f[m], g[m]);
        }
};
...
box2d.b2ParticleSystem.prototype.SolveTensile = function (a) {
    ...
    for (var f = 0; f < this.m_count; f++) (this.m_accumulation2Buffer[f] = box2d.b2Vec2_zero.Clone()), this.m_accumulation2Buffer[f].SetZero();
    ...
    for (var b = this.m_def.surfaceTensionNormalStrength * f, m = box2d.b2_maxParticleForce * f, f = 0; f < this.m_contactBuffer.count; f++)
        if (((g = this.m_contactBuffer.data[f]), g.flags & box2d.b2ParticleFlag.b2_tensileParticle)) {
            var h = g.indexA,
                k = g.indexB,
                l = g.weight,
                g = g.normal,
...
box2d.b2ParticleSystem.prototype.SolveViscous = function () {
    ...
    for (g = 0; g < this.m_contactBuffer.count; g++)
        (h = this.m_contactBuffer.data[g]),
            h.flags & box2d.b2ParticleFlag.b2_viscousParticle && ((k = h.indexA), (l = h.indexB), (m = h.weight), (p = box2d.b2Sub_V2_V2(d[l], d[k], a)), (m = box2d.b2Mul_S_V2(e * m, p, b)), d[k].SelfAdd(m), d[l].SelfSub(m));
};
...
box2d.b2ParticleSystem.prototype.SolveRepulsive = function (a) {
    ...
    for (var d = 0; d < this.m_contactBuffer.count; d++) {
        ...
        if (e.flags & box2d.b2ParticleFlag.b2_repulsiveParticle) {
            var f = e.indexA,
                g = e.indexB;
            this.m_groupBuffer[f] !== this.m_groupBuffer[g] && ((e = box2d.b2Mul_S_V2(a * e.weight, e.normal, b)), c[f].SelfSub(e), c[g].SelfAdd(e));
        }
    }
};
...
box2d.b2ParticleSystem.prototype.SolvePowder = function (a) {
    ...
    for (g = 0; g < this.m_contactBuffer.count; g++)
        (h = this.m_contactBuffer.data[g]),
            h.flags & box2d.b2ParticleFlag.b2_powderParticle && ((l = h.weight), l > e && ((k = h.indexA), (m = h.indexB), (p = h.normal), (h = box2d.b2Mul_S_V2(a * (l - e), p, b)), d[k].SelfSub(h), d[m].SelfAdd(h)));
};
...
box2d.b2ParticleSystem.prototype.SolveSolid = function (a) {
    ...
    for (var d = 0; d < this.m_contactBuffer.count; d++) {
        var e = this.m_contactBuffer.data[d],
            f = e.indexA,
            g = e.indexB;
        this.m_groupBuffer[f] !== this.m_groupBuffer[g] && ((e = box2d.b2Mul_S_V2(a * (this.m_depthBuffer[f] + this.m_depthBuffer[g]) * e.weight, e.normal, b)), c[f].SelfSub(e), c[g].SelfAdd(e));
    }
};
...
box2d.b2ParticleSystem.prototype.SolveZombie = function () {
    for (var a = 0, b = [], c = 0; c < this.m_count; c++) b[c] = box2d.b2_invalidParticleIndex;
    ...
    for (var d = 0, c = 0; c < this.m_count; c++) {
        ...
        if (e & box2d.b2ParticleFlag.b2_zombieParticle) {
            ...
            this.m_handleIndexBuffer.data && (f = this.m_handleIndexBuffer.data[c]) && (f.SetIndex(box2d.b2_invalidParticleIndex), (this.m_handleIndexBuffer.data[c] = null));
            b[c] = box2d.b2_invalidParticleIndex;
        } else
            (b[c] = a),
                c !== a &&
                    (this.m_handleIndexBuffer.data && ((f = this.m_handleIndexBuffer.data[c]) && f.SetIndex(a), (this.m_handleIndexBuffer.data[a] = f)),
    ...
    if (this.m_indexByExpirationTimeBuffer.data) for (e = c = 0; e < this.m_count; e++) (f = b[this.m_indexByExpirationTimeBuffer.data[e]]), f !== box2d.b2_invalidParticleIndex && (this.m_indexByExpirationTimeBuffer.data[c++] = f);
    for (e = this.m_groupList; e; e = e.GetNext()) {
        for (var f = a, g = 0, h = !1, c = e.m_firstIndex; c < e.m_lastIndex; c++) {
            var k = b[c];
            0 <= k ? ((f = box2d.b2Min(f, k)), (g = box2d.b2Max(g, k + 1))) : (h = !0);
        }
        f < g
            ? ((e.m_firstIndex = f), (e.m_lastIndex = g), h && e.m_groupFlags & box2d.b2ParticleGroupFlag.b2_solidParticleGroup && this.SetGroupFlags(e, e.m_groupFlags | box2d.b2ParticleGroupFlag.b2_particleGroupNeedsUpdateDepth))
            : ((e.m_firstIndex = 0), (e.m_lastIndex = 0), e.m_groupFlags & box2d.b2ParticleGroupFlag.b2_particleGroupCanBeEmpty || this.SetGroupFlags(e, e.m_groupFlags | box2d.b2ParticleGroupFlag.b2_particleGroupWillBeDestroyed));
    }
    this.m_count = a;
    this.m_allParticleFlags = d;
    this.m_needsUpdateAllParticleFlags = !1;
    for (e = this.m_groupList; e; ) (a = e.GetNext()), e.m_groupFlags & box2d.b2ParticleGroupFlag.b2_particleGroupWillBeDestroyed && this.DestroyParticleGroup(e), (e = a);
};
...
box2d.b2ParticleSystem.prototype.RotateBuffer = function (a, b, c) {
    ...
    if (a !== b && b !== c) {
        ...
        if (this.m_expirationTimeBuffer.data) {
            ...
            for (var f = this.GetParticleCount(), g = this.m_indexByExpirationTimeBuffer.data, e = 0; e < f; ++e) g[e] = d(g[e]);
        }
        for (e = 0; e < this.m_proxyBuffer.count; e++) (f = this.m_proxyBuffer.data[e]), (f.index = d(f.index));
        for (e = 0; e < this.m_contactBuffer.count; e++) (f = this.m_contactBuffer.data[e]), (f.indexA = d(f.indexA)), (f.indexB = d(f.indexB));
        for (e = 0; e < this.m_bodyContactBuffer.count; e++) (f = this.m_bodyContactBuffer.data[e]), (f.index = d(f.index));
        for (e = 0; e < this.m_pairBuffer.count; e++) (f = this.m_pairBuffer.data[e]), (f.indexA = d(f.indexA)), (f.indexB = d(f.indexB));
        for (e = 0; e < this.m_triadBuffer.count; e++) (f = this.m_triadBuffer.data[e]), (f.indexA = d(f.indexA)), (f.indexB = d(f.indexB)), (f.indexC = d(f.indexC));
        for (e = this.m_groupList; e; e = e.GetNext()) (e.m_firstIndex = d(e.m_firstIndex)), (e.m_lastIndex = d(e.m_lastIndex - 1) + 1);
    }
};
...
box2d.b2ParticleSystem.prototype.SetGroupFlags = function (a, b) {
    ...
    ~this.m_allGroupFlags & b && (b & box2d.b2ParticleGroupFlag.b2_solidParticleGroup && (this.m_depthBuffer = this.RequestBuffer(this.m_depthBuffer)), (this.m_allGroupFlags |= b));
    a.m_groupFlags = b;
};
    ...
    this.m_bodyContactBuffer.count = box2d.std_remove_if(
        ...
        function (h) {
            ...
            if (!h.fixture.TestPoint(k)) {
                for (var l = h.fixture.GetShape().GetChildCount(), m = 0; m < l; m++) if (h.fixture.ComputeDistance(k, c, m) < box2d.b2_linearSlop) return !1;
                ++g;
                return !0;
            }
            return !1;
...
box2d.b2ParticleSystem.prototype.DetectStuckParticle = function (a) {
    0 >= this.m_stuckThreshold ||
        ...
        2 === this.m_bodyContactCountBuffer.data[a] &&
            (++this.m_consecutiveContactStepsBuffer.data[a], this.m_consecutiveContactStepsBuffer.data[a] > this.m_stuckThreshold && (this.m_stuckParticleBuffer.data[this.m_stuckParticleBuffer.Append()] = a)),
...
box2d.b2ParticleSystem.prototype.ApplyDamping = function (a, b, c, d, e, f, g, h) {
    d ? (e.m_linearVelocity.SelfMulAdd(g * a, h), (e.m_angularVelocity += g * c * b)) : this.m_velocityBuffer.data[f].SelfMulAdd(g * a, h);
};
...
box2d.b2StackQueue.prototype.Push = function (a) {
    if (this.m_back >= this.m_capacity) {
        ...
        this.m_front = 0;
        this.m_back >= this.m_capacity && (0 < this.m_capacity ? (this.m_buffer.concat(box2d.b2MakeArray(this.m_capacity)), (this.m_capacity *= 2)) : (this.m_buffer.concat(box2d.b2MakeArray(1)), (this.m_capacity = 1)));
    }
...
box2d.b2VoronoiDiagram.prototype.Generate = function (a, b) {
    ...
    for (var c = 1 / a, d = new box2d.b2Vec2(+box2d.b2_maxFloat, +box2d.b2_maxFloat), e = new box2d.b2Vec2(-box2d.b2_maxFloat, -box2d.b2_maxFloat), f = 0, g = 0; g < this.m_generatorCount; g++) {
        ...
        h.necessary && (box2d.b2Min_V2_V2(d, h.center, d), box2d.b2Max_V2_V2(e, h.center, e), ++f);
    }
        ...
        for (k = 0; k < this.m_countY; k++)
            for (f = 0; f < this.m_countX - 1; f++)
                (c = f + k * this.m_countX),
                    ...
                    d !== g && (e.Push(new box2d.b2VoronoiDiagram.b2VoronoiDiagramTask(f, k, c, g)), e.Push(new box2d.b2VoronoiDiagram.b2VoronoiDiagramTask(f + 1, k, c + 1, d)));
        for (k = 0; k < this.m_countY - 1; k++)
            for (f = 0; f < this.m_countX; f++)
                (c = f + k * this.m_countX),
                    (d = this.m_diagram[c]),
                    (g = this.m_diagram[c + this.m_countX]),
                    d !== g && (e.Push(new box2d.b2VoronoiDiagram.b2VoronoiDiagramTask(f, k, c, g)), e.Push(new box2d.b2VoronoiDiagram.b2VoronoiDiagramTask(f, k + 1, c + this.m_countX, d)));
        for (; !e.Empty(); )
            if (((g = e.Front()), (f = g.m_x), (k = g.m_y), (c = g.m_i), (g = g.m_generator), e.Pop(), (d = this.m_diagram[c]), d !== g)) {
                var h = d.center.x - f,
                    d = d.center.y - k,
                    l = g.center.x - f,
                    m = g.center.y - k;
...
box2d.b2Rope.prototype.Step = function (a, b) {
    if (0 !== a) {
        ...
        c = 1 / a;
        for (d = 0; d < this.m_count; ++d) box2d.b2Mul_S_V2(c, box2d.b2Sub_V2_V2(this.m_ps[d], this.m_p0s[d], box2d.b2Vec2.s_t0), this.m_vs[d]);
    }
};
        ...
        for (a = this.m_bodyList; a; a = a.nextBody)
            for (var b = a.body, c = b.GetWorldCenter(), d = b.GetMass(), e = this.m_bodyList; e !== a; e = e.nextBody) {
                var f = e.body,
                    ...
                    l = g.y - c.y,
                    m = k * k + l * l;
                m < box2d.b2_epsilon || ((k = box2d.b2GravityController.prototype.Step.s_f.Set(k, l)), k.SelfMul((this.G / m / box2d.b2Sqrt(m)) * d * h), b.IsAwake() && b.ApplyForce(k, c), f.IsAwake() && f.ApplyForce(k.SelfMul(-1), g));
            }
    else
        for (a = this.m_bodyList; a; a = a.nextBody)
            for (b = a.body, c = b.GetWorldCenter(), d = b.GetMass(), e = this.m_bodyList; e !== a; e = e.nextBody)
                (f = e.body),
                    (g = f.GetWorldCenter()),
                    (h = f.GetMass()),
                    (k = g.x - c.x),
                    (l = g.y - c.y),
                    (m = k * k + l * l),
                    m < box2d.b2_epsilon || ((k = box2d.b2GravityController.prototype.Step.s_f.Set(k, l)), k.SelfMul((this.G / m) * d * h), b.IsAwake() && b.ApplyForce(k, c), f.IsAwake() && f.ApplyForce(k.SelfMul(-1), g));
};
